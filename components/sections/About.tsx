export default function About() {
  return (
    <section className="flex flex-col gap-2 scroll-mt-24 text-xl" id="about">
      ...
      <div className="flex flex-col md:flex-row gap-4 max-w-6xl">
        <div className="border rounded-2xl p-4 text-2xl text-gray-700">
          <p>
            I&apos;m a full stack developer focused on building modern,
            responsive, and scalable web applications.
          </p>
        </div>
        <div className="border rounded-2xl p-4 text-2xl text-gray-800">
          <p>
        ...
        <div className="border rounded-2xl p-4 text-2xl text-gray-900">
          <p>
